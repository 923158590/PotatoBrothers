...
namespace Game
{
    public class Rifle : Game2DController
    {
        ...
        void Start()
        {
            ...
            attackRange = playerModel.attackRange.Value;
            mBoxCollider2D.size = new Vector2(attackRange, attackRange);
            // 发射子弹
            var attackSpeed = mGun.AttackSpeed - playerModel.attackSpeed / 10 * mGun.AttackSpeed;
